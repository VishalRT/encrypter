 ...
 * Watches the directory containing source_file for FILE_ACTION_MODIFIED and
 ...
 *
 * @param source_file Path to file being watched (UTF-8 std::string)
 * @param destination_file Path to encrypted output file (UTF-8 std::string)
